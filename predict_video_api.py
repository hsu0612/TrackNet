...
class predict_video():
    def __init__(self):
        self.pridict_list = []
    def predict_video(self, input_video_path, output_video_path, save_weights_path, n_classes):
        ...
        while(True):
            ...
            if circles is not None:
                ...
                if len(circles) == 1:
                    ...
                    pridict = {"box": [x, y], "index": currentFrame}
                    self.pridict_list.append(pridict)
        ...
        print("finish")
    def get_predict_list(self, json_save_path):
        with open(json_save_path, 'w') as data_file:
            data = json.dump(self.pridict_list, data_file)